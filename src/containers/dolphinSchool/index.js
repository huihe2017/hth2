...
let data= [
    {
        ...
        title:'什么叫隔夜利息？',
        content:[
            '隔夜利息指持仓隔夜需要支付或者获得的利息。每种货币都有本身的利率，而每项外汇交易涉及两种货币，因此同时涉及两个不同的利率。买入的货币利率高于卖出货币的利率，您就可以赚取隔夜利息。若买入的货币利率低于卖出货币的利率，您就需要支付隔夜利息；比方说，英国的基准利率高于日本，因此如果一个客户买入英镑，他/她将会在GMT时间0点赚取到隔夜利息；相反，如果他/她是卖出英镑，那么他/她将需要在GMT时间0点支付隔夜利息。根据国际银行的规定，海豚汇于GMT时间0点自动将所有未平掉的开启仓位滚存至下一个结算日。'
        ]
    },{
        title:'“日间交易”与“隔夜交易”的区别？',
        content:[
            '日间头寸指在 24 小时内建立，并在GMT时间0点交易日收盘之前平仓的头寸 。 隔夜头寸指在正常交易时间 (GMT时间0点) 后未平仓的头寸， 海豚汇以有竞争力的价格 ( 在货币利息差别的基础上 ) 将隔夜头寸自动将延展至下一个交易日，并计算到交易者的账户余额中去。'
        ]
    },{
        title:'什么是合约单位？',
        content:[
